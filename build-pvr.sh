...
cmake .. \
    ...
    -DCMAKE_C_FLAGS="-Ofast -mcpu=cortex-a53 -fomit-frame-pointer -flto -Wno-error" \
    -DCMAKE_CXX_FLAGS="-Ofast -mcpu=cortex-a53 -fomit-frame-pointer -flto -Wno-error" \
    -DCMAKE_EXE_LINKER_FLAGS="-static-libstdc++ -flto" \
    -DUSING_GLES2=ON \
    -DUSING_EGL=OFF \
    -DUSING_FBDEV=ON \
    -DVULKAN=OFF \
