...
cmake .. \
    ...
    -DCMAKE_C_FLAGS="-O3 -ffunction-sections -fdata-sections -fomit-frame-pointer -flto=auto -Wno-error" \
    -DCMAKE_CXX_FLAGS="-O3 -ffunction-sections -fdata-sections -fomit-frame-pointer -flto=auto -Wno-error" \
