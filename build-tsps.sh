...
cmake .. \
    ...
    -DCMAKE_C_FLAGS="-Ofast -mcpu=cortex-a55 -flto -Wno-error" \
    -DCMAKE_CXX_FLAGS="-Ofast -mcpu=cortex-a55 -flto -Wno-error" \
    -DCMAKE_EXE_LINKER_FLAGS="-Wl,--copy-dt-needed-entries -flto" \
    -DUSING_GLES2=ON \
    -DUSING_EGL=OFF \
    -DUSING_FBDEV=ON \
    -DVULKAN=OFF \
